...
domain_id!(BackupScheduleId);
domain_id!(BackupScheduleRevisionId);
domain_id!(BackupScheduleOccurrenceId);
domain_id!(BackupScheduleMisfireSkipId);
domain_id!(BackupScheduledMaintenanceClaimId);
domain_id!(BackupScheduledMaintenanceWorkerId);
domain_id!(BackupScheduledMaintenanceLeaseToken);
